      ...
      if(!empty($id) && is_numeric($id)){
          include("connexion.php");
             $date_archive = date('y-m-d');
              $list = "UPDATE utilisateurs SET Etat = 1, dateArchive = '$date_archive' WHERE id=$id";
              $pdo->query($list);
    ...
    <h><?php echo $bienvenue?></h>
     ...
     <span id="emar">
      <a href="">  <h>liste des employers </h> </a>
       ...
       <span>
       <a href="liste_des_charchiver.php?"><h>liste archivé</h></a>
       </span>
  ...
  <div class="table-responsive">
    <table class="table table-bordered">
      ...
      while($row=$req->fetch())
      {
         ...
         <td id="action">
         <a href="?id_ar='.$id.'">
         <img id="archive" src="image/archive_FILL0_wght400_GRAD0_opsz48.svg" alt="">
         </a>
         <a href="modification.php?id_modif='.$id.'">
         <img id="modif" src="image/modif.jpg" alt="">
         </a>
         <a href="switch.php?id_change='.$id.'">
         <img id="change" src="image/change-icon-24.jpg" alt="">
         </a>
         </td>
         </tr> </tbody> ';
      } ?>
